...
export const homeItems: HomeItem[] = [
    ...
    { id: "macbook-bundle", sellerId: "forapple", title: "[일괄판매/개별가능] 마지막 맥북프로 M5 Pro 미개봉 , iPad Pro, Dell U3225QE 모니터", meta: "4km · 21시간 전", price: "650,000원", imageAlt: "맥북프로 모델 선택 화면", imageSource: "/reference/macbook-bundle/01.jpg", imageY: 335, likes: 45, chats: 1, directBuy: true },
    ...
    // 222309207: 10:21, header visible. The obscured final row is omitted.
    ...
    // 222308314: top product name is cropped; the obscured final row is omitted.
